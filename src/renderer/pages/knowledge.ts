...
function bindEvents(container: HTMLElement) {
  ...
  const docListContainer = container.querySelector('#docListContainer') as HTMLElement;
  ...
  searchBtn.addEventListener('click', async () => {
    ...
    try {
      const res = await (window as any).api.post('/knowledge/search', { query: q });
...
async function handleFiles(files: File[], dropZone: HTMLElement, docListContainer: HTMLElement) {
