const canvas = (document.getElementById('screenshotCanvas') as any);
...
// 浮动工具栏元素
const floatToolbar = document.getElementById('floatingToolbar') as any;
...
function triggerAction(action) {
  ...
  // 在内存画板进行裁剪
  const cropCanvas = document.createElement('canvas') as any;
  cropCanvas.width = w;
  cropCanvas.height = h;
