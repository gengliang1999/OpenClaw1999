...
const logoBtn = document.getElementById('logoBtn') as HTMLElement;
const appContainer = document.getElementById('appContainer') as HTMLElement;
const quickPanel = document.getElementById('quickPanel') as HTMLElement;
...
const quickCaptureBtn = document.getElementById('quickCaptureBtn') as HTMLElement;
const openMainBtn = document.getElementById('openMainBtn') as HTMLElement;
