...
exports.RetrievalOrchestrator = void 0;
...
class RetrievalOrchestrator {
    ...
    constructor(modelManager, memoryStore, dataDir) {
        ...
        this.memoryEngine = new memory_engine_1.MemoryEngine(modelManager, memoryStore, dataDir);
    }
    /**
     ...
     */
    async retrieveAndOrchestrate(query, convId, maxChars = 15000) {
        const gathered = {
            '用户记忆': [],
            '知识库': [],
            '自进化知识': [],
        ...
        // 2. 双保险召回 (RAG 检索引擎召回)
        try {
            const ragChunks = rag_engine_1.ragEngine.searchRelevant(convId, query, 5); // 增加初筛数量以备预算分配
...
exports.RetrievalOrchestrator = RetrievalOrchestrator;
