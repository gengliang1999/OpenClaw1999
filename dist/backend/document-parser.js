...
class DocumentParser {
     ...
     */
    static async extractTextFromMultiModal(filePath, fileType) {
     ...
     */
    static splitTextIntoChunks(text, chunkSize = 500, chunkOverlap = 50) {
        const chunks = [];
        let currentIndex = 0;
        let chunkId = 0;
        // 清理连续的冗余空白字符与换行
     ...
     */
    static splitTextIntoParentChild(text, parentSize = 1000, parentOverlap = 100, childSize = 200, childOverlap = 20) {
     ...
     */
    static async parseTextFileStream(filePath, onChunksParsed, parentSize = 1000, parentOverlap = 100, childSize = 200, childOverlap = 20) {
        const fs = require('fs');
