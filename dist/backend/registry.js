...
const MODEL_MARKETPLACE = JSON.parse(fs.readFileSync(path.join(__dirname, '../assets/data/local-marketplace.json'), 'utf8'));
// ================== plugin-registry.ts ==================
/**
 * OpenHub 插件注册中心数据
...
module.exports = { MODEL_MARKETPLACE, OPENHUB_REGISTRY, SKILL_MARKET, AUTO_INSTALL_SKILLS };
