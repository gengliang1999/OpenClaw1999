...
exports.MemoryConsolidationPipeline = void 0;
class MemoryConsolidationPipeline {
    modelManager;
    memoryStore;
    constructor(modelManager, memoryStore) {
        ...
        for (const category of categories) {
            try {
                ...
                const memoryTranscript = memories
                    .map((m) => `ID: ${m.id} | 更新时间: ${m.updated_at} | 记忆内容: ${m.content}`)
                    .join('\n');
...
exports.MemoryConsolidationPipeline = MemoryConsolidationPipeline;
