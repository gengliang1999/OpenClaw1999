...
exports.BackgroundJobWorker = void 0;
class BackgroundJobWorker {
     ...
     */
    recoverSuspendedJobs() {
        try {
            this.memoryStore.db.run("UPDATE background_jobs SET status = 'pending', last_error = 'Host process killed unexpectedly' WHERE status = 'processing'");
...
exports.BackgroundJobWorker = BackgroundJobWorker;
