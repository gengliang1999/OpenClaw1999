...
exports.openClawInstaller = exports.OpenClawInstaller = void 0;
...
class OpenClawInstaller {
    installDir;
    repoUrl = 'https://kgithub.com/gengliang1999/OpenClaw1999.git'; // 国内加速源占位
    isProcessing = false;
    constructor() {
    ...
    /** 执行命令并向外部流式输出日志 */
    async execCommand(command, cwd, onLog) {
        return new Promise((resolve, reject) => {
            onLog(`\n> 执行指令: ${command}`);
            const child = (0, child_process_1.exec)(command, { cwd, maxBuffer: 1024 * 1024 * 10 }); // 10MB buffer
...
exports.OpenClawInstaller = OpenClawInstaller;
// 导出单例
exports.openClawInstaller = new OpenClawInstaller();
